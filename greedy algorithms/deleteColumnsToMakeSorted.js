...
const test1 = ["cba","daf","ghi"];
const test2 = ["a","b"];
const test3 = ["zyx","wvu","tsr"];

console.log(minDeletionSize(test1)); // 1
console.log(minDeletionSize(test2)); // 0
console.log(minDeletionSize(test3)); // 3